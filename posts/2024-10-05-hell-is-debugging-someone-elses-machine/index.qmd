...
[That sounds like a lot, but [tidymodels](https://github.com/tidymodels/extratests) actually does this to make sure that specific workflows involving multiple packages are working as they should be.]{.aside}
